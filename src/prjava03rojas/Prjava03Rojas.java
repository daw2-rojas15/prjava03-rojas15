package prjava03rojas;
import java.awt.*; // using AWT containers and components
import java.awt.event.*; // using AWT events and listener interfaces
import java.net.*;
// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava03Rojas extends Frame
...
setTitle("nova finestra de prjava03rojas"); // "this" Frame sets title
setSize(400, 100); // "this" Frame sets initial size
setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
new Prjava03Rojas(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
